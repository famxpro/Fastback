        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="pull-right card-option">
                    <a href="<?=cn($module."/oauth")?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?=lang("add_board")?>"><i class="ft-plus"></i></a>
                </div>
            </div>
        </div>
        <div class="card-block p0">
            <div class="account-manager-list scrollbar scrollbar-dynamic">
                ...
                <div class="item">
                    ...
                    <a class="am-info" href="https://www.pinterest.com/<?=$row->pid?>" target="_blank">
                ...
                <?php }}else{?>
                    <div class="empty">
                        ...
                        <a href="<?=cn($module."/oauth")?>" class="btn btn-primary"><?=lang("add_board")?></a>
                    </div>
                <?php }?>
            </div>
        </div>
