        ...
        $(document).on("click",".actionSearchAddUsername",function(){
            if($("[name='add_username[]']:checked").length > 0){
                $("[name='add_username[]']:checked").each(function(){
                    ...
                    if(!_check_exist){
                        _html_username = '<a href="#" class="activity-option-item activity-option-user"><img src="https://avatars.io/instagram/'+_usernameArray[1]+'" style="margin-right:3px;"><span>@'+_usernameArray[1]+'</span><input type="hidden" name="username[]" value="'+_username+'"><span class="search-target-button-x"><i class="ft-x"></i></span></a>';
        ...
        $(document).on("click", ".actionSearchAddUsernameBlacklist", function(){
            if($("[name='add_username[]']:checked").length > 0){
                $("[name='add_username[]']:checked").each(function(){
                    ...
                    if(!_check_exist){
                        _html_username = '<a href="#" class="activity-option-item activity-option-user"><img src="https://avatars.io/instagram/'+_username_split[1]+'" style="margin-right:3px;"><span>'+_username_split[1]+'</span><input type="hidden" name="username_blacklist[]" value="'+_username_split[1]+'"><span class="search-target-button-x"><i class="ft-x"></i></span></a>';
